  ...
  return (
    <div className="max-w-2xl mx-auto p-8 bg-white shadow-md mt-12 mb-12 rounded-lg">
      ...
      <div className="bg-gray-50 rounded-lg p-6 mb-8">
        ...
        <p className="text-gray-600 mb-2">大学卒業後、WEB制作会社、広告代理店、ECサイトでのデジタルマーケティング領域で活躍。美容・サプリ業界での豊富な実務経験が強みです。</p>
        <p className="text-gray-600 mb-1">【主な経歴】</p>
        <p className="text-gray-600 mb-1">・楽天グループ ヘルスケア事業部 業務支援<br />・国内D2Cメーカー販売強化支援案件にてショップ・オブ・ザ・マンス（2021年6月）受賞<br />・ECサイト インユーマーケティングマネージャー</p>
      </div>
