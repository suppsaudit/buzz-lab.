            ...
            <div className="lg:col-span-8">
              ...
              <div className="space-y-4 text-xl text-gray-700 leading-relaxed font-normal mb-4 md:mb-8" style={{ letterSpacing: '0.01em', lineHeight: '0.85' }}>
                ...
                <span className="hidden lg:block">
                  <p className="font-bold" style={{ lineHeight: '2.2rem' }}>市場発掘からクリエイティブ制作・プロモーション戦略まで トータルプロデュースで確実に届ける。</p>
                  <p className="font-bold" style={{ lineHeight: '2.2rem' }}>美容・健康領域特化のプロモーションパートナーです。</p>
                </span>
              </div>
            </div>
